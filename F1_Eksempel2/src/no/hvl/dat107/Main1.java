...
public class Main1 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Ikke SQL spørring, ligner veldig men er i språket JPQL, spør i en samling av
		 * objekter.
		 */
		...
		/*
		 * Tenker at em holder en samling av objekter som tilsvarer databasen, og det er
		 * i de objektene vi spør
		 */
		...
		try {
			...
			// Automatisk mapping av objekter:
